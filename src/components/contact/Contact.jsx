                ...
                <div className="contactContent">
                   ...
                   <form ref={form} onSubmit={sendEmail} className="contactForm">
                        <div className="contactFormDiv">
                            <label htmlFor="name" className="contactFormTag">Name</label>
                            <input type="text" name="name" className="contactFormInput" id="name"/>
                        </div>
                        <div className="contactFormDiv">
                            <label htmlFor="email" className="contactFormTag">Email</label>
                            <input type="mail" name="email" className="contactFormInput" id="email"/>
                        </div>
                        <div className="contactFormDiv contactFormArea">
                            <label htmlFor="message" className="contactFormTag">Message</label>
